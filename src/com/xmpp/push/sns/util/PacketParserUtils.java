...
package com.xmpp.push.sns.util;
...
import com.xmpp.push.sns.packet.Authentication;
import com.xmpp.push.sns.packet.Bind;
import com.xmpp.push.sns.packet.DefaultPacketExtension;
...
import com.xmpp.push.sns.packet.Registration;
import com.xmpp.push.sns.packet.RosterPacket;
import com.xmpp.push.sns.packet.StreamError;
import com.xmpp.push.sns.packet.XMPPError;
import com.xmpp.push.sns.provider.IQProvider;
import com.xmpp.push.sns.provider.PacketExtensionProvider;
import com.xmpp.push.sns.provider.ProviderManager;
import com.xmpp.push.sns.sasl.SASLMechanism.Failure;
...
public class PacketParserUtils {
    ...
    public static Packet parseMessage(XmlPullParser parser) throws Exception {
        ...
        if(!TextUtils.isEmpty(message.getBody()) && message.getBody().startsWith("{")){
        	Log.e("PacketPaserUtils", message.getBody());
        }
        return message;
    }
