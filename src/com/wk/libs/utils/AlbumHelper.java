...
public class AlbumHelper {
	...
	void buildImagesBucketList() {
		...
		if (cur.moveToFirst()) {
			...
			int photoHeight = cur.getColumnIndexOrThrow(Media.HEIGHT);
			int photoWidth = cur.getColumnIndexOrThrow(Media.WIDTH);
			// 获取图片总数
			...
			do {
				...
				String height = cur.getString(photoHeight);
				String width = cur.getString(photoWidth);
				...
				System.out.println("path -- + -- "+imageItem.thumbnailPath);
