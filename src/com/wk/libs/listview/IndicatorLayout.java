...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
	...
	public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
		...
		Drawable arrowD = getResources().getDrawable(R.drawable.wk_pulltorefresh_indicator_arrow);
		...
		switch (mode) {
			case PULL_FROM_END:
				...
				setBackgroundResource(R.drawable.wk_ptr_indicator_bg_bottom);
			...
			case PULL_FROM_START:
				...
				setBackgroundResource(R.drawable.wk_ptr_indicator_bg_top);
				break;
		}
